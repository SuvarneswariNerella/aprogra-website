    ...
    >
      ...
      <div className="relative w-full h-full max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12 flex flex-col justify-between z-20">
        ...
        <div className="my-auto py-1 sm:py-2 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center w-full grow">
          ...
          {/* ======================================================= */}
          {/* RIGHT COLUMN: Interactive Tech Companion Image Modules  */}
          {/* ======================================================= */}
          <div className="lg:col-span-5 relative h-full flex items-center justify-end min-h-[280px] max-w-lg ml-auto w-full lg:pl-2 z-20">
            ...
            {/* SIDE PANEL 1: Technical Stack / Architecture Image */}
            ...
            {/* SIDE PANEL 2: SaaS / Enterprise Platform Dashboard Image */}
            <div 
              ref={sidePanel2Ref} 
              className="absolute inset-0 w-full h-full flex flex-col justify-center opacity-0 pointer-events-none will-change-[transform,opacity]"
            >
              <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden border border-[#0B0D12]/15 bg-[#FAF8F5] shadow-lg group">
                <img 
            ...
            {/* SIDE PANEL 3: In-House Team & High-Velocity Delivery Image */}
            <div 
              ref={sidePanel3Ref} 
              className="absolute inset-0 w-full h-full flex flex-col justify-center opacity-0 pointer-events-none will-change-[transform,opacity]"
            >
