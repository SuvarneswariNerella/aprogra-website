...
export interface StackedIncidentReportChartProps {
  data?: ChartSeries[];
  title?: string;
  className?: string;
  colorScheme?: string[];
...
export const StackedIncidentReportChart: React.FC<StackedIncidentReportChartProps> = ({
  data,
  ...
  const chartData = data ? validateChartData(data) : validatedChartData;
            ...
            series={
              <StackedAreaSeries
                ...
                area={
                  <Area
                    glow={{ blur: 20 }}
                    color="transparent" // Base area color, gradients will overlay
                    gradient={
                      <Gradient
                        stops={[
